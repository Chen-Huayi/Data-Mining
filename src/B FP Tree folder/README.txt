Part of the codes from open source link from : https://github.com/baiyyang/FP-growth
...
When we dealt with the data, we have several input files. To avoid huge size of appendix files,
